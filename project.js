...
(function () {
  ...
  var heroVisual =
    ...
    (key === 'omniful-ds') ? '<div class="p-herodevice p-herodevice--wide"><span class="p-herodevice__glow" aria-hidden="true"></span>' + macBook('<div style="position:relative;overflow:hidden;background:#F4F5F7;aspect-ratio:16/10;container-type:inline-size;font-family:Poppins,system-ui,sans-serif;color:#222;display:flex;"><div style="width:15%;background:#fff;border-right:1px solid #EEEFF2;display:flex;flex-direction:column;padding:2.6cqw 1.6cqw;gap:1.6cqw;"><div style="display:flex;align-items:center;gap:0.7cqw;margin-bottom:1cqw;"><div style="width:2.2cqw;aspect-ratio:1;border-radius:26%;background:#5468FA;"></div><div style="font-size:1.35cqw;font-weight:600;color:#222;">Omniful DS</div></div><div style="font-size:1cqw;color:#B0B3B9;text-transform:uppercase;letter-spacing:0.06em;font-weight:600;margin-top:0.4cqw;">Foundations</div><div style="font-size:1.15cqw;color:#5468FA;font-weight:600;padding:0.5cqw 0.7cqw;background:#EEF0FE;border-radius:0.5cqw;">Color</div><div style="font-size:1.15cqw;color:#666;padding:0.5cqw 0.7cqw;">Typography</div><div style="font-size:1.15cqw;color:#666;padding:0.5cqw 0.7cqw;">Spacing</div><div style="font-size:1.15cqw;color:#666;padding:0.5cqw 0.7cqw;">Icons</div><div style="font-size:1cqw;color:#B0B3B9;text-transform:uppercase;letter-spacing:0.06em;font-weight:600;margin-top:1cqw;">Components</div><div style="font-size:1.15cqw;color:#666;padding:0.5cqw 0.7cqw;">Button</div><div style="font-size:1.15cqw;color:#666;padding:0.5cqw 0.7cqw;">Input</div><div style="font-size:1.15cqw;color:#666;padding:0.5cqw 0.7cqw;">Table</div></div><div style="flex:1;min-width:0;display:flex;flex-direction:column;"><div style="display:flex;align-items:center;justify-content:space-between;padding:2.6cqw 3.2cqw 1.8cqw;border-bottom:1px solid #EEEFF2;"><div><div style="font-size:2.2cqw;font-weight:600;letter-spacing:-0.02em;">Color</div><div style="font-size:1.2cqw;color:#999;margin-top:0.4cqw;">55 tokens · 230 icons · 30+ components</div></div><div style="display:flex;gap:0.9cqw;align-items:center;"><div style="padding:0.8cqw 1.6cqw;border-radius:0.55cqw;background:#5468FA;color:#fff;font-size:1.2cqw;font-weight:600;">Button</div><div style="padding:0.8cqw 1.6cqw;border-radius:0.55cqw;border:1px solid #DEDEDE;font-size:1.2cqw;color:#444;">Ghost</div></div></div><div style="padding:2.2cqw 3.2cqw 0;font-size:1.05cqw;color:#999;text-transform:uppercase;letter-spacing:0.05em;font-weight:600;">Primary</div><div style="padding:1.2cqw 3.2cqw 0;display:grid;grid-template-columns:repeat(5,1fr);gap:1.5cqw;"><div><div style="aspect-ratio:1;border-radius:0.9cqw;background:#5468FA;"></div><div style="font-size:0.95cqw;color:#999;margin-top:0.5cqw;">Primary</div></div><div><div style="aspect-ratio:1;border-radius:0.9cqw;background:#495AD9;"></div><div style="font-size:0.95cqw;color:#999;margin-top:0.5cqw;">Dark</div></div><div><div style="aspect-ratio:1;border-radius:0.9cqw;background:#CCD2FD;"></div><div style="font-size:0.95cqw;color:#999;margin-top:0.5cqw;">Light</div></div><div><div style="aspect-ratio:1;border-radius:0.9cqw;background:#EEF0FE;border:1px solid #DEDEDE;"></div><div style="font-size:0.95cqw;color:#999;margin-top:0.5cqw;">Lighter</div></div><div><div style="aspect-ratio:1;border-radius:0.9cqw;background:#222;"></div><div style="font-size:0.95cqw;color:#999;margin-top:0.5cqw;">Ink</div></div></div><div style="padding:1.8cqw 3.2cqw 0;font-size:1.05cqw;color:#999;text-transform:uppercase;letter-spacing:0.05em;font-weight:600;">Status — tags only</div><div style="padding:1.2cqw 3.2cqw 2cqw;display:grid;grid-template-columns:repeat(6,1fr);gap:1.3cqw;"><div style="aspect-ratio:1;border-radius:0.65cqw;background:#067603;"></div><div style="aspect-ratio:1;border-radius:0.65cqw;background:#C21808;"></div><div style="aspect-ratio:1;border-radius:0.65cqw;background:#F9720A;"></div><div style="aspect-ratio:1;border-radius:0.65cqw;background:#AE1AF7;"></div><div style="aspect-ratio:1;border-radius:0.65cqw;background:#00CFE8;"></div><div style="aspect-ratio:1;border-radius:0.65cqw;background:#CD5700;"></div></div><div style="flex:1;background:#F9F9F9;border-top:1px solid #EEEFF2;padding:2cqw 3.2cqw;display:flex;flex-direction:column;gap:1.5cqw;"><div style="font-size:1.05cqw;color:#999;text-transform:uppercase;letter-spacing:0.05em;font-weight:600;">Components — size scale</div><div style="display:flex;align-items:center;gap:1.1cqw;"><div style="padding:1cqw 1.9cqw;border-radius:0.55cqw;background:#5468FA;color:#fff;font-size:1.3cqw;font-weight:500;">Primary · 40</div><div style="padding:0.8cqw 1.6cqw;border-radius:0.5cqw;background:#5468FA;color:#fff;font-size:1.1cqw;font-weight:500;">36</div><div style="padding:0.4cqw 1.05cqw;border-radius:0.4cqw;background:#5468FA;color:#fff;font-size:0.95cqw;font-weight:500;">24</div><div style="padding:1cqw 1.9cqw;border-radius:0.55cqw;border:1px solid #DEDEDE;font-size:1.3cqw;color:#444;background:#fff;">Ghost</div><div style="padding:0.8cqw 1.5cqw;border-radius:999px;background:#EEF0FE;color:#5468FA;font-size:1.1cqw;font-weight:600;">Tag</div></div><div style="display:flex;align-items:center;gap:0.75cqw;"><div style="width:2.4cqw;aspect-ratio:1;border-radius:0.45cqw;background:#fff;border:1px solid #EEEFF2;"></div><div style="width:2.4cqw;aspect-ratio:1;border-radius:0.45cqw;background:#fff;border:1px solid #EEEFF2;"></div><div style="width:2.4cqw;aspect-ratio:1;border-radius:0.45cqw;background:#fff;border:1px solid #EEEFF2;"></div><div style="width:2.4cqw;aspect-ratio:1;border-radius:0.45cqw;background:#fff;border:1px solid #EEEFF2;"></div><div style="width:2.4cqw;aspect-ratio:1;border-radius:0.45cqw;background:#fff;border:1px solid #EEEFF2;"></div><div style="width:2.4cqw;aspect-ratio:1;border-radius:0.45cqw;background:#fff;border:1px solid #EEEFF2;"></div><div style="width:2.4cqw;aspect-ratio:1;border-radius:0.45cqw;background:#fff;border:1px solid #EEEFF2;"></div><div style="width:2.4cqw;aspect-ratio:1;border-radius:0.45cqw;background:#fff;border:1px solid #EEEFF2;"></div><div style="font-size:1.05cqw;color:#999;margin-left:0.4cqw;">+222 icons</div></div></div></div></div>') + '</div>' :
